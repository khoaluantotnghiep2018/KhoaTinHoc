<div class="log-form">
    <div class="form-wrapper">
        ...
        <form action="" class='form-dangnhap'>
            ...
            <div class="log-form__title">Thành viên đăng nhập</div>
            <label for="">
            ...
            <label for="">
                <a href="" class='link-register'>Đăng ký</a>
            </label>
            <label for="">
        ...
        <form action="" class='form-dangky'>
            <div class="log-form__title">Thành viên đăng ký</div>
            <label for="">
                <span class='icon'><i class="fas fa-user"></i></span>
                <input type="text" placeholder="Tên đăng nhập hoặc email">
                <span class="error"></span>
...
<header class="header">
    ...
    <div class="header-login"><i class="fas fa-user"></i></div>
</header> <!-- END HEADER -->
...
<nav class="nav">
    ...
    <ul>
        ...
        <li><a href="">Ý kiến sinh viên</a></li>
        <!-- <li><a href=""></a></li> -->
